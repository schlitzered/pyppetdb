...
class TestRedactorsUnit(unittest.TestCase):
    ...
    def test_base_redactor_string(self):
        self.assertEqual(self.base_redactor.redact("My password is PASSWORD"), "My password is XXXXX")
        self.assertEqual(self.base_redactor.redact("SECRET123 is here"), "XXXXX is here")
    ...
    def test_reports_redactor(self):
        ...
        report_data = {
            ...
            "report": {
                "logs": [
                    {"level": "info", "message": "My PASSWORD is here"}, # message SHOULD be redacted
                    {"level": "PASSWORD", "message": "Normal"} # level SHOULD NOT be redacted
                ],
                "resources": [
                    {
        ...
        self.assertEqual(redacted["report"]["resources"][0]["resource_title"], "SECRET123")
