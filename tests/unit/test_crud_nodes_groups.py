...
class TestCrudNodesGroupsUnit(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        with patch("pyppetdb.crud.nodes_groups.CrudNodesGroupsCache") as mock_cache_class:
    ...
    async def test_reevaluate_node_membership(self):
        ...
        matched_groups = await self.crud.reevaluate_node_membership(node_id="node1", node_facts=facts)
