...
class TestCrudHieraLevelDataUnit(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_validation_failure(self):
        payload = HieraLevelDataPost(
            data={"key": "abc"},
            facts={"certname": "wrong.example.com"}
        )
    ...
    async def test_delete(self):
        ...
        self.crud._delete.assert_called_once_with(query={
            "id": "d1",
            "key_id": "k1",
            "level_id": "l1",
        })
    ...
    async def test_update(self):
        ...
        await self.crud.update(_id="d1", key_id="k1", level_id="l1", payload=payload, fields=[])
