...
class TestCrudHieraLevelsUnit(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get(self):
        self.crud._get = AsyncMock(return_value={"id": "level1", "priority": 10})
    ...
    async def test_update(self):
        self.crud._update = AsyncMock(return_value={"id": "level1", "priority": 20})
        ...
        self.crud._update.assert_called_once_with(
            query={"id": "level1"},
            fields=[],
            payload={"priority": 20, "description": None},
        )
