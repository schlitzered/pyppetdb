...
class ApiV1CAIntegrationTests(IntegrationTestBase):
    ...
    def test_ca_lifecycle(self):
        ...
        # Delete Space first
        resp = self.client.delete(
            f"/api/v1/ca/spaces/{space_id}", headers=self._auth_headers()
        )
        self.assertEqual(resp.status_code, 200)
        ...
        # 6. Delete Sub CA
        resp = self.client.delete(
            f"/api/v1/ca/authorities/{sub_ca_id}", headers=self._auth_headers()
        )
        self.assertEqual(resp.status_code, 200)
    ...
    def test_crl_integration(self):
        ...
        # 1. Setup Hierarchy
        self.client.post(
            f"/api/v1/ca/authorities/{root_ca_id}",
            headers=self._auth_headers(),
            json={"cn": "Root"},
        )
        self.client.post(
            f"/api/v1/ca/authorities/{sub_ca_id}",
            headers=self._auth_headers(),
            json={"parent_id": root_ca_id, "cn": "Sub"},
        )
        self.client.post(
            f"/api/v1/ca/spaces/{space_id}",
            headers=self._auth_headers(),
            json={"ca_id": sub_ca_id},
        )
        ...
        # Revoke the cert
        self.client.put(
            f"/api/v1/ca/spaces/{space_id}/certs/{serial}",
            headers=self._auth_headers(),
            json={"status": "revoked"},
        )
    ...
    def test_authority_history(self):
        ...
        self.client.post(
            f"/api/v1/ca/authorities/{root1_id}",
            headers=self._auth_headers(),
            json={"cn": "Root1"},
        )
        self.client.post(
        ...
        self.client.post(
            f"/api/v1/ca/authorities/{root2_id}",
            headers=self._auth_headers(),
            json={"cn": "Root2"},
        )
        resp = self.client.put(
    ...
    def test_authority_certs_and_crl(self):
        ...
        resp = self.client.get(
            f"/api/v1/ca/authorities/{ca_id}/certs", headers=self._auth_headers()
        )
        self.assertEqual(resp.status_code, 200)
    ...
    def test_search_certs_by_cn(self):
        ...
        resp = self.client.get(
            f"/api/v1/ca/spaces/{space_id}/certs",
            headers=self._auth_headers(),
            params={"cn": cert_cn},
        )
        self.assertEqual(resp.status_code, 200)
        ...
        resp = self.client.get(
            f"/api/v1/ca/authorities/{ca_id}/certs",
            headers=self._auth_headers(),
            params={"cn": cert_cn},
        )
        self.assertEqual(resp.status_code, 200)
